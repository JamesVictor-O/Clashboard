  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 8px 2px rgba(255,184,0,0.35)" },
          "50%":       { boxShadow: "0 0 28px 8px rgba(255,184,0,0.75)" },
        },
        "wipe-out": {
      ...
      animation: {
        ...
        "pulse-glow":        "pulse-glow var(--glow-duration, 2s) ease-in-out infinite",
        "wipe-out":          "wipe-out var(--wipe-duration, 0.4s) ease-in forwards",
        "crowd-pop":         "crowd-pop var(--pop-duration, 0.8s) ease-out forwards",
        "score-fill":        "score-fill var(--fill-duration, 1.2s) cubic-bezier(0.34,1.56,0.64,1) forwards",
        "payout-flash":      "payout-flash var(--flash-duration, 1.5s) ease-in-out forwards",
      ...
      backgroundImage: {
        "arena-gradient": "radial-gradient(ellipse at center top, #1A1A28 0%, #0A0A0F 70%)",
